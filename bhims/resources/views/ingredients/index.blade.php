                ...
                <div class="mb-6 bg-gray-50 p-4 rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="search" id="search" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                        <div>
                            <label for="category" class="block text-sm font-medium text-gray-700">Category</label>
                            <select id="category" name="category" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            ...
                                            <span class="text-gray-500 text-xs">{{ $ingredient->unit_of_measure }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($ingredient->current_stock <= $ingredient->minimum_stock * 0.5)
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-2">
                                            ...
                                            <button type="button" 
                                                    @click="openModal('{{ $ingredient->id }}', '{{ addslashes($ingredient->name) }}')"
        ...
        Alpine.data('ingredientDelete', () => ({
            ...
            confirmDelete() {
                if (this.ingredientId) {
                    const form = document.getElementById('delete-ingredient-form');
...
<div x-data="ingredientDelete" x-cloak>
    <!-- Overlay -->
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <form id="delete-ingredient-form" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                        <button type="button"
                                @click="confirmDelete"
